...
(() => {
  ...
  var config = {
    ...
    bot: {
      TOKEN: "",
      USERNAME: "",
      CHANNEL_ID: -1002212345678,
      ADMIN_IDS: [1111111111, 2222222222],
  ...
  async function copyMessage(chatId, originChatId, messageId, protectContent = false, replyToMessageId = null, replyMarkup = null) {
    const payload = {
      chat_id: chatId,
  ...
  async function saveMessageKey(messageId, secretKey, senderId) {
